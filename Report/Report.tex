...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Viene valutato se la lista così ottenuta sia composta da trentadue elementi, in caso contrario viene restituito un messaggio d'errore.
